	...
	class NXData
	{
		...
		string getCustomCommand(void)
		{
		    return this->customCommand;
                ...
                list<NXSambaMount*>& getSmbMountList(void)
                {
                    return this->smbMountList;
                }
		...
		void setCustomCommand(string customCommand)
		{
		    this->customCommand = customCommand;
                ...
                void setSmbMountList(list <NXSambaMount *> smbMountList)
                {
                    this->smbMountList = smbMountList;
                }
		...
		string customCommand;
                list<NXSambaMount *> smbMountList;
	};
